          ...
          <form action="#">
            <div className="mb-4">
              <label htmlFor="username" className="block text-gray-700">
                <i className="fas fa-user mr-2"></i> ID Policia o correo electrónico
              </label>
              <input
                type="text"
                id="username"
            ...
            <button type="submit" className="w-full bg-blue-500 text-white p-3 rounded-lg">Ingresar</button>
          </form>
          
          <p className="mb-6">¿No tienes una cuenta? Registráte</p>
