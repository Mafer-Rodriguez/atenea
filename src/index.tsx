...
import ImageCarousel from './main';
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 p-4">
            ...
            <p className="text-lg mb-6">Varuna es una iniciativa que busca transformar el agua residual tratada en
              ...
              volúmenes de agua para sus procesos industriales y fabricación de plásticos.</p>
            <button
      ...
      <section className="text-center py-16" style={{backgroundColor: '#E9F9FF'}}>
        ...
        En Varuna, combinamos la potencia de la inteligencia artificial con tecnologías avanzadas de filtración para capturar y eliminar eficazmente los microplásticos de las aguas residuales. Nuestro enfoque no solo es efectivo, sino también eficiente, asegurando que las aguas tratadas cumplan con los estándares más rigurosos de calidad.        </p>
       <div>
        <ImageCarousel />
       </div>
